...
export async function getLatestGames() {
  const LATEST_GAMES =
    "https://backend.metacritic.com/v1/xapi/finder/metacritic/web?sortBy=-metaScore&productType=games&page=1&releaseYearMin=1958&releaseYearMax=2024&offset=0&limit=24&apiKey=1MOZgmNFxvmljaQR1X9KAij9Mo4xAY3u";
...
export async function getGameDetails(slug) {
  const GAME_DETAILS = `https://backend.metacritic.com/v1/xapi/composer/metacritic/pages/games/${slug}/web?&apiKey=1MOZgmNFxvmljaQR1X9KAij9Mo4xAY3u`;
